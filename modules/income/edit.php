...
<head>
    ...
    <title>Einnahme bearbeiten - StreamNet Finance</title>
    <link
        rel="stylesheet"
    ...
    <div class="app-layout">
        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    <h1 style="color: #4ade80; margin-bottom: 5px;"><i class="fa-solid fa-sack-dollar"></i>&nbsp;&nbsp;Einnahme bearbeiten</h1>
            ...
            <div class="form-container">
                <div class="form-card">
                    <div class="form-header">
                        <h2><i class="fa-solid fa-sack-dollar"></i>&nbsp;&nbsp;Einnahme bearbeiten</h2>
                        <p>Ändere die Details und speichere deine Anpassungen</p>
                    </div>

                    <div class="current-info">
                        <h4>📋 Aktuelle Einnahme</h4>
                        <div class="current-info-grid">
                            ...
                            <div class="current-info-item">
                                ...
                                <span class="current-info-value">+€<?= number_format($income['amount'], 2, ',', '.') ?></span>
                            </div>
                            <div class="current-info-item">
                                <strong>Datum:</strong><br>
                                <span class="current-info-value"><?= date('d.m.Y', strtotime($income['date'])) ?></span>
                            </div>
                            <div class="current-info-item">
                                <strong>Beschreibung:</strong><br>
                                <span class="current-info-value"><?= htmlspecialchars($income['note']) ?: 'Keine Beschreibung' ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="note" name="note"
                                ...
                                placeholder="Woher kommt das Geld? (optional)"><?= htmlspecialchars($income['note']) ?></textarea>
                        </div>

                        <div class="form-actions">
                            <a href="index.php" class="btn btn-cancel">Abbrechen</a>
                            <a href="delete.php?id=<?= $income['id'] ?>" class="btn btn-delete"> <i class="fa-solid fa-trash-can"></i> Löschen</a>
                            <button type="submit" class="btn btn-income"><i class="fa-solid fa-floppy-disk"></i> Änderungen speichern</button>
                        </div>
                    </form>
                </div>
            </div>
